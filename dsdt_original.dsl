DefinitionBlock ("dsdt.aml", "DSDT", 2, "Intel ", "CALPELLA", 0x06040000)
{
    ...
    Name (PDBR, 0x4D)
    Name (SMBL, 0x10)
    OperationRegion (PNVS, SystemMemory, 0xD779BDA4, 0x0100)
    Field (PNVS, AnyAcc, Lock, Preserve)
    {
        SLEP,   8
    }
    OperationRegion (GNVS, SystemMemory, 0xD779BBA4, 0x0200)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB)
                {
                    ...
                    Scope (\_SB)
                    {
                        OperationRegion (TCG1, SystemMemory, 0xD779BA9E, 0x00000007)
                        ...
                        OperationRegion (SMI1, SystemMemory, 0xD779BEBD, 0x00000090)
    ...
    Scope (_SB)
    {
        OperationRegion (SNVS, SystemMemory, 0xD779BAA5, 0x000000FF)
